#!/usr/bin/env python3
"""Standalone test script for BSP engine implementation.

This script verifies the core BSP functionality without importing the main app.
"""
...
spec = importlib.util.spec_from_file_location(
    "bsp_engine",
    os.path.join(os.path.dirname(__file__), "claude_multi_terminal/layout/bsp_engine.py")
)
bsp_engine = importlib.util.module_from_spec(spec)
spec.loader.exec_module(bsp_engine)

BSPTree = bsp_engine.BSPTree
SplitDirection = bsp_engine.SplitDirection
